...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-lt" role="banner" style="background-image: url(images/img_4.jpg)">
		<div class="overlay"></div>
             ...
             <h1 class="singup_h1" align="center" ><ins> Sign Up  </ins></h1>	
            <div class="gtco-container">
                <div class="row">
                    <div class="col-md-12 col-md-offset-0 text-center">


                        <div class="row row-mt-8em_sing">
                                                ...
                                                <form action="signed.php" method="post">
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" class="form-control" name="secquestion" id="secquestion">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="callsign">Personal call</label>
